      ...
      <div className="w-full max-w-md">
        ...
        <div className="p-8 space-y-6 bg-white rounded-2xl shadow-xl border border-gray-100 transition-all duration-300 hover:shadow-2xl">
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex justify-between mb-1.5">
                  ...
                  <Link to="/forgot-password" className="text-xs text-indigo-600 hover:text-indigo-800 font-medium">Forgot password?</Link>
                </div>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-gray-400">
                    <Lock size={18} />
          ...
          <p className="text-sm text-center text-gray-500 mt-6">
            ...
            <Link to="/signup" className="text-indigo-600 font-semibold hover:text-indigo-800 transition-colors">Create an account</Link>
          </p>
        </div>
